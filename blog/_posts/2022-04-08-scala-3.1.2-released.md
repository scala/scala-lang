...
Sbt, starting from version 1.7.0-M1, has a setting `scalaOutputVersion` that not only sets the compiler flag mentioned above, but also determines which version of the standard library will be specified as your dependency. For example, specifying
