...
prototype, called `fox`. The project can start small with simple changes to get
familiar with the codebase, and gradually step up as progress happens.
...
You need to be familiar with Scala and enjoy building tools for developers.
