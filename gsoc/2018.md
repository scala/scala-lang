...
This poses major challenged in porting the toolchain to Windows. In this project you're
going to work on continuing work on the port of Scala Native to Windows based on [prior
