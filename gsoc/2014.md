...
Scala 2.11, show that these interopolators can be implemented by
...
Mentored by [Christopher Vogt](http://people.epfl.ch/christopher.vogt)
...
matrices. Framworks like [NumPy][br3] support arbitrarily dimensioned
...
The ideal student would have a strong command of Scala, familarity
...
[some work][br10] in this direction, but this project would a strong
