...
This past May, we held our first [advisory board meeting](https://scala-lang.org/blog/2016/05/30/scala-center-advisory-board.html), to discuss some of the areas that the newly-formed Scala Center should focus on.
...
In pursuit of this goal, today, we've published a reformed [Scala Improvement Specification and Submission Process](https://docs.scala-lang.org/sips/sip-submission.html).
