...
* [SLIP 22 - Async](https://github.com/scala/improvement-proposals/pull/21) is tracked in [Issue 22](https://github.com/scala/slip/issues/22). Seth is to obtain more info about the status of SLIP 22 for the next meeting.
